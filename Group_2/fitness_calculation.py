...
def fitness_value(s1,s2):   ### THIS IS THE FUNCTION TO CALL  s1->[row,column,subject]  s2->[row,column,subject]
    ...
    distance_coefficient = 1 * math.pow(distance_coefficient,7)   # distance coefficient ranges from 1 to 2.82
    subject_dissimilarity_coefficient = 1 * math.pow(subject_dissimilarity_coefficient*10,2)
